#codigo base desenvolvido para implementar todas as funcoes testadas para o sistema idealizado

avaliacaoesUsuario = {'Ana':
                          {'Freddy x Jason': 2.5,
...
avaliacaoesFilme = {'Freddy x Jason':
                        {'Ana': 2.5,
                         'Marcos:': 3.0,
                         'Pedro': 2.5,
                         'Adriano': 3.0,
...
# compara 1 usuario em relacao a todos
